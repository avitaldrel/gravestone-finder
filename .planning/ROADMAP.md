...
Plans:
- [x] 02-01-PLAN.md -- Install Fuse.js, create search components (SearchBar, ResultCard, NoResults, NoData, SearchResults, SearchPage), wire root page as search homepage
- [x] 02-02-PLAN.md -- Fuse.js search behavior tests, SearchPage integration tests, visual verification checkpoint

**UI hint**: yes

### Phase 3: Demo Mode
**Goal**: A "Try Demo" button seeds the app with ~50 realistic sample veteran flags so organizers and visitors can explore all features (import, search, directory) without entering real data
**Depends on**: Phase 2
**Requirements**: DM-01
**Success Criteria** (what must be TRUE):
  1. Visitor or organizer can click a "Try Demo" button and the app populates with ~50 sample flags
  2. All features work with demo data: search finds sample names, directory lists entries
...
**Plans**: Executed directly (no formal plan artifacts)
**UI hint**: yes
...
| 2. Visitor Search | 2/2 | Complete | 2026-04-12 |
| 3. Demo Mode | Done | Complete | 2026-04-12 |
