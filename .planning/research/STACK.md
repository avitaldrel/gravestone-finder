...
**Domain:** Memorial flag tracking/finding web application (location-based grid, CRUD management, search)
...
npx create-next-app@latest gravestone-finder --typescript --tailwind --eslint --app --src-dir

# Core dependencies
npm install @supabase/supabase-js @supabase/ssr leaflet react-leaflet react-hook-form zod @hookform/resolvers lucide-react
...
npx shadcn@latest add button input table dialog card command
...
**If the event is non-commercial (volunteer/community/nonprofit):**
...
**If the event has any commercial aspect (sponsors, donations, ticket revenue):**
...
**If you want zero cost with commercial flexibility:**
...
**If real-time flag updates matter (organizers updating positions while visitors search):**
...
---
*Stack research for: Memorial flag tracking/finding web application*
*Researched: 2026-04-06*
